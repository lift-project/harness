...
void execute_run(const size_t &M, const size_t &N,
                 ...
                 const cl::Buffer &matA_dev, const cl::Buffer &matB_dev,
                 const cl::Buffer &output_dev, std::shared_ptr<Run> &r) {
...
void run_harness(std::vector<std::shared_ptr<Run>> &all_run, const size_t M,
                 const size_t K, const size_t N, const std::string &matA_file,
                 const std::string &matB_file, const std::string &gold_file,
                 const bool force, const bool transposeA, const bool transposeB,
                 const bool transposeOut, const bool threaded,
                 const bool binary) {
  using namespace std;
  ...
  cl::Buffer matA_dev =
      OpenCL::alloc(CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, buf_size_A,
                    static_cast<void *>(matA.data()));
  cl::Buffer matB_dev =
      OpenCL::alloc(CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, buf_size_B,
