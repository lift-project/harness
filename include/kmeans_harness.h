...
void run_harness(std::vector<std::shared_ptr<Run>> &all_run,
                 const size_t num_points, const size_t num_clusters,
                 const size_t num_features, const std::string &points_file,
                 const std::string &clusters_file, const std::string &gold_file,
  ...
  cl::Buffer points_dev =
      OpenCL::alloc(CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, buf_size_points,
