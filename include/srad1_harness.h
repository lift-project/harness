...
void set_kernel_args(const shared_ptr<Run> run, const cl::Buffer &image_dev,
                     const cl::Buffer &coeffs_dev, const size_t M,
                     const size_t N) {
  unsigned i = 0;
...
void compute_gold(const size_t M, const size_t N, Matrix<float> &image,
  ...
  File::load_input_debug(gold, "/home/bastian/development/exploration/executor/"
                               "datasets/srad_data/coeffs.txt");
  File::load_input_debug(image, "/home/bastian/development/exploration/"
                                "executor/datasets/srad_data/imagebefore.txt");
