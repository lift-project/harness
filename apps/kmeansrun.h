...
template <typename T> struct KMeansRun : public Run {
   ...
   */
  KMeansRun(const std::vector<std::string> &values, std::size_t num_points,
            std::size_t num_clusters, std::size_t num_features,
            std::size_t default_local_0, std::size_t default_local_1,
            std::size_t default_local_2)
      : Run(values, default_local_0, default_local_1, default_local_2),
        num_points(num_points), num_clusters(num_clusters),
